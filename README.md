...
Depending on the `isOnline` prop, the background color of `span.status` must change. This
...
Компонент повинен приймати два пропа `title` та `stats`, в яких вказується
